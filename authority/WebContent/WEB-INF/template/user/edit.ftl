...
<body>
<form method="post" action="${base}/user/update.jhtml" id="inputForm">
		...
		<div class="tabContent">
			<table class="input">
				<tr>
					...
					<td colspan="2">
						<input type="text" name="username" id="username" class="text" value="${user.username}" maxlength="200" />
					</td>
				</tr>
				<tr>
					<th>
