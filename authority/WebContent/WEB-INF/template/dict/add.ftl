...
<span class="active-path"><em>&gt;</em>新增</span>
			<table class="input">
				<tr>
					<th>
					...
					<td>
						<input type="text" class="text2" name="dictType" id="dictType" value="" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" class="text2" name="dictTypeName" id="dictTypeName" value="" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" class="text2" name="dictCode" id="dictCode" value="" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" class="text2" name="dictName" id="dictName" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" class="text2" name="orderId" id="orderId" value="" />
					</td>
				</tr>
				...
				<th>描述</th>
				<td>
					<textarea class="textarea" name="remark" id="remark" rows="5" cols="100"></textarea>
				</td>
				</tr>
			<tr>
				<th>
