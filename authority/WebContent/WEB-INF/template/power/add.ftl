...
<body>
<form action="${base}/power/save.jhtml" method="post" id="inputForm" style="min-height:360px;max-height:450px;">
				...
				<tr>
				   ...
				   <td>
		              <div class="controls text-cont-box">
		                ...
		                <input type="text" id="menuName" name="menuName" class="m-wrap text-tree-inp" readonly onclick="focusMenu()" placeholder="请选择菜单">
		              </div>
				   </td>
				</tr>
				<tr>
