...
<title>登录</title>
<link rel="stylesheet" type="text/css" href="<%=base%>/static/login/css/main.css">
<link rel="stylesheet" type="text/css" href="<%=base%>/static/login/css/lhgcalendar.css">
<link rel="stylesheet" type="text/css" href="<%=base%>/static/login/css/blue.css">
...
<div class="login-main">
		<div class="login-top">信达权限管理中心</div>
		<div class="login-mid">
			<div class="box1200">
